...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-black border-t border-white/10 pt-16 md:pt-20 pb-8 font-sans">
      <div className="max-w-[1440px] w-full mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 min-[450px]:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-white text-app-sm leading-relaxed pr-4 mb-8">
            ...
            <div className="flex flex-col gap-5 mb-8">
              <div className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-primary shrink-0 mt-0.5" fill="var(--primary)" stroke="black" />
                <span className="text-white text-app-sm">Cupertino, CA 95014-2358, USA</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-primary shrink-0" fill="var(--primary)" stroke="black" />
                <span className="text-white text-app-sm">+1 (888) 207 5969</span>
              </div>
            </div>

            <div className="flex flex-col gap-2">
              <h4 className="text-primary text-app-base font-semibold tracking-wide">
                Subsidiaries:
              </h4>
              <p className="text-white text-app-sm">
            ...
            <div key={colIdx} className="flex flex-col gap-10">
              {column.sections.map((section, secIdx) => (
                <div key={secIdx} className="flex flex-col">
                  <h4 className="text-primary text-app-base font-normal tracking-wide mb-5">
                    {section.title}
                  </h4>
                  <ul className="flex flex-col gap-4">
                    {section.links.map((link, linkIdx) => (
                      <li key={linkIdx}>
                        <Link
                          href="#"
                          className="text-white text-app-sm hover:text-primary transition-colors"
                        >
                          {link}
                        </Link>
                      </li>
        ...
        <div className={`pt-8 border-t border-white/10 flex ${isMobile ? 'flex-col items-center gap-6' : 'flex-row justify-between items-center'}`}>
          ...
          <p className={`text-white text-app-xs ${isMobile ? 'text-center' : 'text-left'} leading-relaxed`}>
...
function SocialIcons() {
  return (
    <div className="flex items-center gap-6">
      ...
      {/* X / Twitter */}
      <Link href="#" className="text-white hover:text-primary transition-colors" aria-label="X (Twitter)">
      ...
      {/* Facebook */}
      <Link href="#" className="text-white hover:text-primary transition-colors" aria-label="Facebook">
